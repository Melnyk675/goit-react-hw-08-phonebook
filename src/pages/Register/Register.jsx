import { Label, FormReg, SubmitButton, InputReg, InputPassword, RegMail,
  RegUser, RegPassWord, LinkToLog, ContLabel, Container, TitleReg,
    ...
    <section>
      <Container>
        <FormReg
          ...
          onFinish={onFinish}
          initialValues={{
            residence: ['jafgubbp', 'wolhfde', 'ebxaom'], 
            prefix: '86',
          }}
          scrollToFirstError
        >
          ...
          <Label>
            ...
            <ContLabel>
              or <LinkToLog to="/login"> log in</LinkToLog>if you already have an account{' '}
            </ContLabel>
          </Label>
        </FormReg>
      </Container>
